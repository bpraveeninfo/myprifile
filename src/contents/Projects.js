...
import comakeit from '../img/pimages/comakeit.png';

import fourids from '../img/pimages/4ids.png'
import apsecm from '../img/pimages/apsecm.png';
import coservesolutions from '../img/pimages/coservesolutions.png';
import desimechi from '../img/pimages/desimechi.png';
import kentmskclinic from '../img/pimages/kentmskclinic.png';
                    ...
                    <div class="container-fluid">
                     <h1 className="subtopic">Projects</h1>
                        <div class="row">
                            ...
                            <div class="col-sm">
                            <div className="card">
                                <img src={comakeit} class="card-img-top" alt="..." />
